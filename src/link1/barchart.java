...
public class barchart extends ApplicationFrame {
     ...
     */
    public barchart(final String title,ArrayList ar) {
...
//        final String series2 = "Noncancer";
			...
			//dataset.addValue(Float.parseFloat(res[1]), series2, cat);
                      //  dataset.addValue(0.8, series1, category1);
                       // dataset.addValue(0.6, series1, category2);
                        ...
                        dataset.addValue(0.5, series1, category3);
			dataset.addValue(0.9, series1, category4);
    ...
    private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        final JFreeChart chart = ChartFactory.createBarChart(
            "AREA UNDER CURVE",         // chart title
            "Percentage",               // domain axis label
            "AUC",                  // range axis label
            dataset,                  // data
